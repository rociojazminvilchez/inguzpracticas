            ...
            <div id="carouselActividades" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="/inguz/public/assets/img/actividades/hiit1.png" class="d-block w-100" alt="actividades-1">
                    </div>
                    <div class="carousel-item">
                        <img src="/inguz/public/assets/img/actividades/hiit2.png" class="d-block w-100" alt="actividades-2">
                    </div>
                    <div class="carousel-item">
                        <img src="/inguz/public/assets/img/actividades/hiit3.png" class="d-block w-100" alt="actividades-3">
                    </div>
                </div>
            </div><br>
        </div>
