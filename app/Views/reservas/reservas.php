...
<div class="alert alert-warning" role="alert">
  <strong>Atención:</strong> Este panel es para visualizar las reservas realizadas.
</div>
<div class="card text-center">
<div class="card-header">
    <ul class="nav nav-tabs card-header-tabs">
      <li class="nav-item">
        <a class="nav-link active" aria-current="true" href=<?= base_url('/reservas/reservas'); ?>> <label style="color:red; font-weight: bold;">*Reservas realizadas</label></a>
      </li>
    </ul>
  </div><br>
