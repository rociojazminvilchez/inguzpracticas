...
<div class="card-header">
    <ul class="nav nav-tabs card-header-tabs">
      ...
      <li class="nav-item">
        <a class="nav-link active" aria-current="true" href=<?= base_url('/creditos/membresia_activa'); ?>> Activas</label></a>
      </li>
      <li class="nav-item">
        <a class="nav-link active" aria-current="true" href=<?= base_url('/creditos/membresia_rechazada'); ?>> Rechazadas</a>
      </li>
      <li class="nav-item">
        <a class="nav-link active" aria-current="true" href=<?= base_url('/creditos/membresia_vencida'); ?>> <label style="color:red; font-weight: bold;">*Vencidas</label></a>
      </li>
    </ul>
  </div><br>
  <h3 class="my-3" id="titulo" style="margin: 20px;font-family: 'Times New Roman', serif;"> Membresias vencidas </h3> 
